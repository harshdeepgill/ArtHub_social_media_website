...
const Home = () => {
  ...
  return (
    <div>
      <Hero/>
      <section id='hero' style={{ height: "30rem", backgroundColor: "#91D9A8", fontFamily: "Nunito" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
          <h1 className='head-text' style={{ marginTop: "3rem" }}>Choose from the Catagories</h1>
        ...
        <Flex gap="4rem" mt="4rem" justify="center">
          <Box style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
            ...
            <Text fontSize="xl">Anime Art</Text>
          </Box>
