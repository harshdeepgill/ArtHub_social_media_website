        ...
        <div className='col'>
          <div className='card text-center '>
            ...
            <div className='card-body'>
              ...
              <button className='btn btn-success btn-lg w-100 btn-success'>{subscription === "basic" ? "Upgrade" : subscription === "premuim" ? "Current Plan" : subscription === "elite" ? "Change Plan" : ""}</button>
            </div>
          </div>
        </div>
        <div className='col'>
