  ...
  return (
    <section id='hero' style={{ height: "70vh", backgroundColor: "#91D9A8", fontFamily: "Nunito" }}>
      ...
      <div style={{ display: 'flex', gap: "1rem", justifyContent: "space-evenly", flexWrap: "wrap" }}>
        <Image objectFit="cover" w="17%" src="https://firebasestorage.googleapis.com/v0/b/festive-crayon.appspot.com/o/Posts%2FAscendance%20of%20a%20Bookworm.png44370915-aedf-42a9-b51f-d132766b0191?alt=media&token=9835d4db-20cd-4be9-ad14-87b4d8528cc5" style={{ border: "1px solid coral" }} />
      </div>
    </section>
  )
}
