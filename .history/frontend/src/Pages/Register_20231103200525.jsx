...
const Register = () => {
  ...
  return (
    <>
      {success ? (
        <section className={`${styles.register_form_section} ${styles.Nunito}`} style={{ marginTop: "2rem" }}>
          <Center>
        ...
        <section className={`${styles.register_form_section} ${styles.Nunito}`} style={{ marginTop: "2rem" }}>
          ...
          <p className={`${styles.Nunito}`} style={{ display: "flex", flexDirection: "column", alignItems: "center", fontSize: "1.1rem", marginTop: "1rem", marginBottom: "1rem" }}>
            Already Registered?
            <br />
